...
from Fityfeed.decoratos import admin_only, allowed_users
from .models import *
from .forms import *
...
def loginPage(request):
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            messages.info(request, 'username or passowrd is invalid')
...
def userPage(request):
    ...
    myfilter = fooditemFilter(request.GET, queryset=fooditem)
